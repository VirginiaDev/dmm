	...
	public static void main(String args[]) throws Exception {
		...
		/* client1.getParams().setParameter("sgc_username", "gupshupmain");
		 ...
		 client1.getParams().setParameter("sgcSubmitLoginForm", "1");*/
		    ...
		    GetMethod method = new GetMethod("http://localhost:8853/vns-dmm/chatBox.jsp");
		    //PostMethod method=new PostMethod("http://localhost:8853/vns-dmm/chatBox.jsp");
		    try{
        ...
        try (CloseableHttpClient client = HttpClientBuilder.create().build()) {
        	...
        	HttpGet request=new HttpGet("http://localhost:8853/vns-dmm/chatBox.jsp");
        	request.setHeader("Host", "localhost:8853");
