  ...
  <div class="container">
    <div id="photo-slider" class="photo-slider">
      <div class="slider-photo-list">
        <div class="slider-photo" style="background-image:url(assets/img/port-1.jpg)"></div>
        <div class="slider-photo" style="background-image:url(assets/img/port-2.jpg)"></div>
        <div class="slider-photo" style="background-image:url(assets/img/port-3.jpg)"></div>
        <div class="slider-photo" style="background-image:url(assets/img/port-4.jpg)"></div>
         <div class="slider-photo" style="background-image:url(assets/img/port-5.jpg)"></div>
          <div class="slider-photo" style="background-image:url(assets/img/port-6.jpg)"></div>
      </div>
    </div>
