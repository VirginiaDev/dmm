        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 bg-right pt-20">
            ...
            <ul class="keyword-list">
              ...
              <li> <b class="s1m">Social media advertising</b>Social media advertising (a kind of PPC ads) is the process of advertising through different social media platforms (Facebook, Instagram, Twitter, Pinterest, LinkedIn) to get exposure to a more prominent audience. </li>
			  <li> <b class="s1m">Remarketing Ads</b> Remarketing Ads (a kind of PPC ads) are the technique that helps you to reach out to those customers or audiences that have left the conversion process somewhere in the middle.</li>
			  <li> <b class="s1m">Sequential remarketing</b>Sequential remarketing (a kind of PPC ads) is a kind of funnel marketing where we take our audience from a path that helps us to convert them into leads. </li>
			  <li> <b class="s1m">Google Shopping</b>Google shopping ads (a kind of PPC ads) are also known as product shopping ads are the ads that help you to showcase your product in front of your audience with its detailed description. </li>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6">
            ...
            <p>Get in touch with our experts and know our result-driven strategies to reach rank #1.</p>
              ...
              <input type="hidden" name="pageName" value="ppc">
