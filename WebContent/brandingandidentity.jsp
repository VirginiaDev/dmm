...
<h1 style="font-size: 55px;"><span>Branding & Identity</span></h1>
<p>VNSDMM is among the top brand and identity design consulting firms providing excellent services to companies all over the world.</p>
</section>
</section>
<section class="col-md-6">
<div id="animation_branding" class="s-img"></div>
</section>
...
<h1>Brand that communicates and resonates</h1>
<p>Our tech freaks bring their technical skills in work to conceptualize your profession with an ideal preview that gives your brand a refreshing logo with a perfect message. Through branding and identity we integrate our uniquely created designs to show exactly what your brand is about. We cater to your business prerequisites serving you with the right expertise and help you achieve impactful progressive goals.</p><p> We create logos that are effectively creative with simplicity- a design that can be comprehended and remembered. We take a road that creates an impact on the way a brand is perceived. Putting color, Typography, and images altogether give a clear vision and one of a kind visual identity to your brand and that’s where VNS DMM plays a crucial role. We shape your image in the eyes of the world.</p>
</section>
</section>
...
<h1>What we can design for you</h1>
              ...
              <section class="row">
                ...
                <section class="col-md-6 col-xs-12">
                  <section class="get-text">
                    <form id="free_audit_details" action="save_free_audit_details.jsp?source_page=brandingandidentity" method="post">
...
<script>
	...
	let animation5 = bodymovin.loadAnimation({
        container: document.getElementById('animation_branding'),
        renderer: 'svg',
        loop: true,
        autoplay: true,
        path: 'js/animated/animate_branding.json'
    });
...
let animation2 = bodymovin.loadAnimation({
    ...
    function freeAudit(){
    	...
    	var source_page='brandingandidentity';
    	 var phoneno = /^\d{10}$/;
