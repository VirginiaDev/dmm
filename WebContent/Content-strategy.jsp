        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 bg-right pt-20">
            ...
            <ul class="budget-list">
			  ...
			  <li> <i class="bx bx-check-double"></i><b>Full-proof and Best Content Marketing Strategy for b2b, b2c, all types of organizations.</b></li>
			  <li> <i class="bx bx-check-double"></i><b>Higher Ranking and Traffic </b></li>
			  <li> <i class="bx bx-check-double"></i><b>Our experts help in revamping the strategies to meet changes.</b></li>
			  ...
			  <li> <i class="bx bx-check-double"></i><b>Our expertise in Content Marketing</b></li>
			  ...
			  <li> <i class="bx bx-check-double"></i><b>SEO Content Marketing Strategy.</b></li>
			  <li> <i class="bx bx-check-double"></i><b>Content Marketing Strategy for Startups.</b></li>
						...
						<div class="col-sm-6 col-md-6 col-xs-12">
						  ...
						  <div class="col-sm-6 col-md-6 col-xs-12">
						   <div class="form-group htb">
							...
							<input type="hidden" id="pageName2" value="content_strategy">
							<input type="hidden" id="title2" value="How_VNS_makes_your_Content_and_Content_Marketing_Strategy_the_Strongest_point">
						  </div>
						  </div>
         ...
         <div class="col-lg-6">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            ...
            <ul class="keyword-list">
              <li><i class="bx bx-check-double"></i> <b>Business Write-Up</b></li>
              <li><i class="bx bx-check-double"></i> <b>Product Listing Write-Up</b> </li>
			  <li><i class="bx bx-check-double"></i> <b>Blogs & Article Write Up</b> </li>
			  <li><i class="bx bx-check-double"></i> <b>Website Content Write-Up</b> </li>
			  <li><i class="bx bx-check-double"></i> <b>Marketing Collaterals Write-Up</b> </li>
			   <li><i class="bx bx-check-double"></i> <b>Video & TVC Scripts</b> </li>
			   <li><i class="bx bx-check-double"></i> <b>SEO Copywriting</b> </li>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            ...
            <ul class="keyword-list">
              <li><i class="bx bx-check-double"></i> <b>Gather relevant data.</b></li>
              <li><i class="bx bx-check-double"></i> <b>Analysis of the data.</b> </li>
			  <li><i class="bx bx-check-double"></i> <b>Chalk down your Content Marketing Strategy</b> </li>
			  <li><i class="bx bx-check-double"></i> <b>Draft your content.</b> </li>
			  <li><i class="bx bx-check-double"></i> <b>Publish and Optimize</b> </li>
			   <li><i class="bx bx-check-double"></i> <b>Promote & Review</b> </li>
			   <li><i class="bx bx-check-double"></i> <b>Last but not least repeat.</b></li> 
            </ul>
