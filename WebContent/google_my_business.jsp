      ...
      <div class="container-fluid">
         ...
         <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pl-6">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pt-70">
            <h1 class="smm-title-b"><b>What is Google My Business (GMB)?</b></h1>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 pt-20">
            <h3 class="smm-title-b"><b>Benefits of Complete Google My Business Listing (GMB).</b></h3>
            <ul class="budget-list">
              <li><i class="fa fa-check" aria-hidden="true"></i> <b>Your business shows up in Google Maps Searches</b></li>
              <li><i class="fa fa-check" aria-hidden="true"></i> <b>Ratings and reviews boost Your Appeal</b> </li>
			  <li><i class="fa fa-check" aria-hidden="true"></i> <b>Increase traffic and Sales of business</b> </li>
			  <li><i class="fa fa-check" aria-hidden="true"></i> <b>Customer to Learn More About Your Business</b> </li>
			  <li><i class="fa fa-check" aria-hidden="true"></i> <b>Gives the customers more transparency</b> </li>
			   <li><i class="fa fa-check" aria-hidden="true"></i> <b>Rank Higher in Search Results</b> </li>
			   <li><i class="fa fa-check" aria-hidden="true"></i> <b>Creates a trust</b> </li>
            </ul>
         ...
         <div class="col-lg-6 col-sm-6 col-md-6 pl-6">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 pt-0">
            ...
            <ul class="budget-list">
			  ...
			  <li><i class="fa fa-check" aria-hidden="true"></i> <b>Full-proof and Best Google My Business (GMB)listing strategy</b> </li>
			  <li><i class="fa fa-check" aria-hidden="true"></i> <b>Higher Ranking and Traffic</b> </li>
			  <li><i class="fa fa-check" aria-hidden="true"></i> <b>Our experts help in google my business support and google my contact.</b> </li>
			   ...
			   <li><i class="fa fa-check" aria-hidden="true"></i> <b>Our expertise in Google My Business (GMB)listing</b></li> 
			   <li><i class="fa fa-check" aria-hidden="true"></i> <b>Dedicated plan of action</b></li>
			   <li><i class="fa fa-check" aria-hidden="true"></i> <b>Worked for over 100+ clients globally (majorly in Australia,
			    New Zealand, India)</b></li>
			    <li><i class="fa fa-check" aria-hidden="true"></i> <b>Our Google My Business (GMB)listing strategy suitable for all types of businesses.</b></li> 
            </ul>
    ...
    <section class="about">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 pt-20">
            <h3 class="smm-title-b"><b>How do Local SEO help in GMB Listing?</b></h3>
            <p class="content-mark">Local SEO is one of the prominent factors in the GMB listing of your organization. Local SEO keeps your GMB profile updated and as accurate and transparent as possible to get a creamed audience. With the help of Local SEO, your business profile in the GMB becomes more attractive, trustworthy, and appealing to the audience.</p>

            <h5 class="content-mark">Step-by-Step Process of creating My business profile in Google My Business (GMB)</h5>
            <ul class="budget-list">
              <li><i class="fa fa-check" aria-hidden="true"></i> <b>Create your google my business account in Google My Business</b></li>
              <li><i class="fa fa-check" aria-hidden="true"></i> <b>Enter the information as per the requirement</b> </li>
			  <li><i class="fa fa-check" aria-hidden="true"></i> <b>Verify your account</b> </li>
			  <li><i class="fa fa-check" aria-hidden="true"></i> <b>Your account is ready!</b> </li>
			  <li><i class="fa fa-check" aria-hidden="true"></i> <b>Keep your account up-to-date.</b> </li>
            </ul>
