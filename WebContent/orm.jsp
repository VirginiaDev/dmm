					...
					<section class="row">
						<section class="col-md-6">
							<section class="digital-title wow fadeInLeft">
								<h1 style="font-size: 55px;"><span>Online Reputation<br> Management</span></h1>
									<p>VNS DMM brings their clients in the best books online.</p>
							</section>
						</section>
					<section class="col-md-6">
						<div id="animation_orm" class="s-img"></div>
				</section>
			</section>
		</section>
	</section>
		...
		<section class="row">
			<section class="col-md-12">
				<section class="desc-title wow fadeInDown">
					<h1>Trust us and we will make Customer trust you</h1>
					<p>It does take dedicated time and efforts with appropriate techniques to fabricate a robust reputation in the market. How you want to be perceived in the marketplace is when reputation plays its job. People have no idea how ORM can impact their business and deals. Companies of every size from small to large can benefit from the services of ORM.</p>
 					<p>The Internet these days is a life saver and people not only search but they also trust whatever they see and read online. In particular they decide based on the reputation and information they gather from the web which likewise influences a website’s ranking on Google.</p>
	...
	<section class="container">
		...
		<section class="col-md-5">
			<section class="desc-title wow fadeInDown" style="text-align:left;">
				<h1>ORM Virtuous Cycle</h1>
					<section class="d-span">
						<section class="d-categories">
							<ul>
								<li><span></span>Good-quality, accurate, and balanced content ranks profoundly online.</li>
								<li><span></span>People normally click on results that provide them the information they want.</li>
								<li><span></span>When search engines observe a pattern of a specific type of information being liked and preferred, search engines then start promoting it.</li>
								<li><span></span>Social media expands the reach and impact of engaging, top-notch items.</li>
								<li><span></span>After this more links are being created from Follow-up content, media coverage, and developments.</li>
							</ul>
						</section>
					</section>
				</section>
            ...
            <section class="contact-set">
              <section class="row">
                ...
                <section class="col-md-6 col-xs-12">
                  ...
                  <form id="free_audit_details" action="save_free_audit_details.jsp?source_page=orm" method="post">
...
<div id="animate2"></div> </section>
              ...
              <section class="col-md-6">
                <section class="part-right">
                  ...
                  <section class="p-right"> <a href="https://dmm.virtuosonetsoft.com/contact" class="carrow cta"> START A PARTNERSHIP <span></span> </a> </section>
                </section>
              </section>
            </section>
          </section>
