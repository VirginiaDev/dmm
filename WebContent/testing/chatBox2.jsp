 ...
 databaseRef.once('value', function(snapshot) {
  ...
  function savemessage(message){
	   ...
	   if(message.trim()==''){
		...
		// var chat_status=document.getElementById('chatstatus').value;
	    alert("chatstatus=="+document.getElementById('chatstatus').value);
		   ...
		   var data = {
		    ...
		    default_msg:0,
		    admin_id:'none',
		    cs:document.getElementById('chatstatus').value
...
<script>
function checkChatStatus(chatid){

	$.ajax({
	url: "checkChatStatus.jsp?chatid="+chatid,
	type: 'GET',
	data: null,
	success: function(data) {
	document.getElementById('checkvalue').innerHTML=data;
