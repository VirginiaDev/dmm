...
<body>
  ...
  <div class="ravana">
    <img src="dussehra_img/rav-1.jpg" alt="Ravana" /><span class="one"></span><span class="two"></span>
    <span class="three"></span><span class="four"></span><span class="five"></span><span class="six"></span>
    <span class="seven"></span><span class="eight"></span><span class="nine"></span><span class="fire"></span>
    <span class="fire1"></span><span class="fireface"></span><span class="fire2"></span><span class="fire3"></span>
    <span class="fire4"></span><span class="fire5"></span><span class="fire6"></span><span class="fire7"></span>
  ...
  <div class="evil-buttons">
    <div class="container">
      <div class="row">
        <button type="button" class="btn btn-dark m-2" id="1">Over Eating</button>
        <button type="button" class="btn m-2 evilbutt1" id="2">Ignoring health</button>
        <button type="button" class="btn m-2 evilbutt2" id="3">Toxicity</button>
        <button type="button" class="btn m-2 evilbutt3" id="4">Ungratefulness</button>
        <button type="button" class="btn m-2 evilbutt4" id="5">Comparison</button>
        <button type="button" class="btn btn-primary m-2" id="6">Not Letting go</button>
        <button type="button" class="btn btn-secondary m-2" id="7">Revenge</button>
        <button type="button" class="btn btn-success m-2" id="8">Addiction</button>
        <button type="button" class="btn btn-danger m-2" id="9">Lust</button>
        <button type="button" class="btn btn-warning m-2" id="10">Anger</button>
        <button type="button" class="btn btn-info m-2" id="11">Negativity</button>
        <button type="button" class="btn btn-light m-2" id="12">Greed</button>
        <button type="button" class="btn btn-dark m-2" id="13">Pride</button>
        <button type="button" class="btn btn-secondary m-2" id="14">Envy</button>
        <button type="button" class="btn btn-success m-2" id="15">Conscientiousness</button>
        <button type="button" class="btn btn-danger m-2" id="16">Mindlessness</button>
        <button type="button" class="btn btn-warning m-2" id="17">Unsettled</button>
        <button type="button" class="btn btn-info m-2" id="18">Ego</button>
        <button type="button" class="btn btn-light m-2" id="19">Apathy</button>
        <button type="button" class="btn btn-dark m-2" id="20">Fear</button>
      </div>
    </div>
  </div>
  ...
  <div class="proceed">
    <div class="container-fluid text-center">
      <button type="button" class="btn btn-dark m-2" id="proceed">Proceed</button>
    </div>
  </div>
