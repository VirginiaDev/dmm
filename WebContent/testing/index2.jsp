...
<div id="site-wrapper">
  <header>
          ...
          <div class="col-md-5">
            <section class="right-menu wow fadeInRight">
              <ul class="nav nav-tabs">
                <li class="active"> <a data-target="#Work" target="_blank" data-hover="tab" href="portfolio.jsp"><span class="dotted animated"></span>Work</a> </li>
                <li> <a data-target="#Services" target="_blank" data-hover="tab" href="services.jsp"><span class="dotted"></span>Services</a> </li>
                <li> <a data-target="#About" target="_blank" data-hover="tab" href="aboutus.jsp"><span class="dotted"></span>About</a> </li>
    ...
    <section class="container">
      <div class="logo">
        <h1> <a href="index.jsp"> <img src="images/logo.svg"> </a> </h1>
      </div>
    </section>
  </header>
  <main role="main">
      ...
      <div class="barba-container">
        ...
        <p>With the fusion of digital tools and creativity<br>
          we solve your problems.</p>
        <a href="services.jsp" target="_blank" class="carrow cta"> Know More <span></span> </a>
        </div>
        ...
        <section class="container">
          <div class="row  wow fadeInDown">
            <div class="col-md-6 col-xs-12 no_pad">
              <div class="p-info">
                <p>We are virtuoso in webpage and app developments. 
                  And concepts of SMM, SEO, ORM, UI, UX, tracking and
                  content marketing are a fuel to these creations.</p>
              </div>
            </div>
            <div class="col-md-3 col-xs-12 no_pad"> <a href="portfolio.jsp" target="_blank">
              <div class="portfolio-img port"> <img src="images/a1.png"/>
                <div class="box-content">
                  <h3 class="title">Helto&nbsp;-</h3>
                  <span class="post">Evolving Healthcare System</span> <span class="post">Branding & Identity</span> </div>
              </div>
              </a> 
            </div>
            <div class="col-md-3 col-xs-12 no_pad"> <a href="portfolio.jsp" target="_blank">
            ...
            <div class="col-md-4 col-xs-12 no_pad"> <a href="portfolio.jsp" target="_blank">
              <div class="portfolio-img port"> <img src="images/a2.png"/>
                <div class="box-content">
                  <h3 class="title">Helto&nbsp;-</h3>
                  <span class="post">Evolving Healthcare System</span> <span class="post">Branding & Identity</span> </div>
              </div>
            ...
            <div class="col-md-5 col-xs-12 no_pad"> <a href="portfolio.jsp" target="_blank">
              <div class="portfolio-img port"> <img src="images/a4.png"/>
                <div class="box-content">
                  <h3 class="title">Helto&nbsp;-</h3>
                  <span class="post">Evolving Healthcare System</span> <span class="post">Branding & Identity</span> </div>
              </div>
          ...
          <div class="viewall">
            <div class="row">
              ...
              <div class="col-md-6 no_pad">
                <div class="p-right wow fadeInRight"> <a href="portfolio.jsp" class="carrow cta"> View all work <span></span> 
                </a> 
                </div>
              </div>
            </div>
        ...
        <section class="container">
          <section class="row">
            <section class="col-md-8 col-xs-12">
              <section class="j-left wow fadeInLeft">
                ...
                <section class="feature">
                  <section class="row">
                    <section class="col-md-4 col-xs-12 no_pad">
                      <section class="feat-set">
                        <section class="row">
                          <section class="col-xs-4 no_pad">
                            <section class="feat-icon"> <img src="images/MaskGroup2.svg"/> </section>
                          </section>
                    ...
                    <section class="col-md-4 col-xs-12 no_pad">
                      <section class="feat-set">
                        <section class="row">
                          <section class="col-xs-4 no_pad">
                            <section class="feat-icon"> <img src="images/MaskGroup3.svg"/> </section>
                          </section>
                          <section class="col-xs-8">
                            <section class="feat-text">
                              <p>Exclusive<br>
                    ...
                    <section class="col-md-4 col-xs-12 no_pad">
                      <section class="feat-set">
                        <section class="row">
                          <section class="col-xs-4 no_pad">
                            <section class="feat-icon"> <img src="images/MaskGroup4.svg"/> </section>
                          </section>
                          <section class="col-xs-8">
                            <section class="feat-text">
                              <p>Customized<br>
            ...
            <section class="col-md-4 col-xs-12">
              <section class="j-img wow fadeInRight"> <img src="images/img_2.svg"/> </section>
            </section>
          </section>
            ...
            <section class="row">
                ...
                <section class="exp-set wow fadeInLeft">
                  <section class="row">
                    <section class="col-xs-3 no_pad">
                      <section class="exp-icon"> <img src="images/MaskGroup5.svg"/> </section>
                    </section>
                    <section class="col-xs-9">
                      <section class="exp-text">
                        <p><span class="red">10+</span><br>
              ...
              <section class="col-sm-3 col-xs-12">
                <section class="exp-set wow fadeInLeft">
                  <section class="row">
                    <section class="col-xs-3 no_pad">
                      <section class="exp-icon"> <img src="images/MaskGroup6.svg"/> </section>
                    </section>
                    <section class="col-xs-9">
                      <section class="exp-text">
                        <p><span class="red">4+</span><br>
                          Countries Served</p>
                      </section>
                    </section>
                  </section>
              ...
              <section class="col-sm-3 col-xs-12">
                <section class="exp-set wow fadeInRight">
                  <section class="row">
                    <section class="col-xs-3 no_pad">
                      <section class="exp-icon"> <img src="images/MaskGroup8.svg"/> </section>
                    </section>
                    <section class="col-xs-9">
                      <section class="exp-text">
                        <p><span class="red">150+</span><br>
                          Employees</p>
                      </section>
                    </section>
                  </section>
          ...
          <section class="row">
            <section class="col-md-7 col-xs-12">
              <section class="s-left wow fadeInLeft"> <span>WE SPECIALIZE IN</span>
				...
				<a href="brandingandidentity.jsp" target="_blank" data-target="#Branding" data-toggle="collapse" data-capability="1" data-reveal="up"> Branding and Identity <span></span></a>
				<a href="digitalmarketing.jsp" data-target="#Digital" data-toggle="collapse" data-capability="2" data-reveal="up"> Digital Marketing <span></span></a>
				<a href="webanddevelopment.jsp" data-target="#Web" data-toggle="collapse" data-capability="3" data-reveal="up"> Web and App Development <span></span></a>
				<a href="orm.jsp" data-target="#Online" data-toggle="collapse" data-capability="4" data-reveal="up"> Online Reputation Management <span></span></a> </section>
              </section>
            </section>
      ...
      <section class="review">
        <section class="container">
          ...
          <section class="testimonial wow fadeInDown">
            ...
            <div class="controls testimonial_control pull-right"> <a class="left fa fa-long-arrow-left testimonial_btn" href="#carousel-example-generic"
                  data-slide="prev"></a> <a class="right fa fa-long-arrow-right testimonial_btn" href="#carousel-example-generic"
                ...
                <section class="col-md-6 col-xs-12">
                  <section class="get-text">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12 no_pad">
                        <div class="form-group">
                          <input type="text" placeholder="Phone Number" id="phn" class="form-control" name="phn" required="" data-error="Please enter your Phone Number">
                        </div>
                      </div>
                      <div class="col-md-12 no_pad" style="width:100%;">
                        <div class="submit-button text-left">
                          <div class="form-group">
                            <button class="contact btn-5">
                            <a class="arrow view-all reveal--up revealed" href="#" data-reveal="up">Send Now<span></span> </a>
                            </button>
          ...
          <section class="connect wow fadeInDown">
            <section class="row">
              ...
              ArrayList<homepage_photos> h=apiController2.fetchHomepagePhotos();
              for(int i=0;i<h.size();i++){
              %>
                <section class="col-md-4 col-xs-12">
                  <section class="connect-img"> 
				  <img src="<%=h.get(i).getFilename()%>" alt="<%=h.get(i).getFilename()%>" class="image"/>
				   <div class="overlay">
              ...
              <section class="col-md-2 col-xs-12">
                <section class="foot-text">
                  <ul>
                    ...
                    <li><a href="portfolio.jsp">Our Works</a></li>
              ...
              <section class="col-md-9 no_pad">
                <div id="inquiry__form">
                  <form id="inquiry" novalidate="true" class="shake animated">
                    ...
                    <div class="row"> <span class="up reveal--up revealed" data-reveal="up">MORE ABOUT YOU </span>
                      <div class="col-md-12 no_pad">
                        <div class="form-group">
                          <input type="text" class="form-control" id="name" name="name" placeholder="Name" required="" data-error="Please enter your name">
                      ...
                      <div class="col-md-6 no_pad">
                        <div class="form-group">
                          <input type="text" placeholder="Company Name" id="email" class="form-control" name="email" required="" data-error="Please enter your email">
                          <div class="help-block with-errors">
                            <ul class="list-unstyled">
                      ...
                      <div class="col-md-6 no_pad">
                        <div class="form-group">
                          <input type="text" placeholder="Estimate Budget" id="phn" class="form-control" name="phn" required="" data-error="Please enter your Phone Number">
                          <div class="help-block with-errors">
                            <ul class="list-unstyled">
                      ...
                      <div class="col-md-12 no_pad" style="width:100%;">
                        <div class="form-group">
                          <textarea class="form-control" id="message" placeholder="Your Message" rows="3" data-error="Please enter Breif about your project" style="width:100%;" required=""></textarea>
                          <div class="help-block with-errors">
                            <ul class="list-unstyled">
                        ...
                        <div class="submit-button text-left">
                          <div class="form-group"> <a class="carrow cta" id="form-submit" type="submit" style="pointer-events: all; cursor: pointer;max-width: 300px;margin-top: 3em;"> Send Business Enqiry <span></span> </a>
                            <div id="msgsubmit" class="h3 text-center hidden"></div>
                            <div class="clearfix"></div>
                          </div>
                        </div>
