...
int spotLeftCount=0;
                  ...
                  ApiController apiController=new ApiController();
                  ArrayList<contact> fa=apiController.fetchContactRequestsAccordingToMultipleFilters(fromdate,todate,services, pageid, total);
                 for(int i=0;i<fa.size();i++){
...
<%} }else if(multiplefiltered.equals("all")){
	...
	int spotLeftCount=0;
	                  ...
	                  ApiController apiController=new ApiController();
	                  ArrayList<contact> fa=apiController.fetchContactRequests("0", pageid, total);
	                 for(int i=0;i<fa.size();i++){
