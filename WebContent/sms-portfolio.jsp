...
.container{position: relative; width: 50%;height: 100vh;}



@media screen and (max-width: 768px){
.container{ width: 100%;}
  .container:nth-child(2){background-color: transparent !important;}
  .container h2{color: white;font-size: 14px;top: inherit;bottom: 30px;
  -webkit-transform: translate(-50%,0%);-ms-transform: translate(-50%,0%);transform: translate(-50%,0%);}.top-tag {color: #fff;font-size: 30px;
  font-weight: 800;padding-left: 10px;padding-top: 0px;}
.back-2 {display: block; margin-bottom: 40px;}}
   </style>
