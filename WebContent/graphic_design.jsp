      ...
      <div class="container-fluid">
         ...
         <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pt-80">
            <h2 class="smm-title-b"><b>Curiosity leads to creativity.</b></h2>

            <p class="content-mark">Graphic design includes all the kind of creatives such as advertising design, environmental design,
             publication design, motion design, corporate design, UI design, web design, packaging design, information design, and so on.
              The need for unique Graphic design is increasing at an alarming rate and, it becomes difficult for clients to get the best 
              Graphic design services provider company. VNS has some of the best graphic designers that have proved their 
            excellence under all the circumstances keeping in view the client requirements.</p>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 pt-0">
            ...
            <ul class="budget-list">
			  ...
			  <li> <i class="fa fa-check" aria-hidden="true"></i><b>Transparent with the clients.</b></li>
			  <li> <i class="fa fa-check" aria-hidden="true"></i><b>Our expertise in all kind of Graphic Designing</b></li>
			  ...
			  <li> <i class="fa fa-check" aria-hidden="true"></i><b>Our Graphic Design process strategy is suitable for all types of businesses</b></li> 
            </ul>
         ...
         <div class="col-lg-6">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            ...
            <ul class="keyword-list">
              <li><i class="fa fa-check" aria-hidden="true"></i> <b>Brand Communication</b></li>
              <li><i class="fa fa-check" aria-hidden="true"></i> <b>Brand Strategy</b> </li>
			  <li><i class="fa fa-check" aria-hidden="true"></i> <b>Logo & identity Design</b> </li>
			  <li><i class="fa fa-check" aria-hidden="true"></i> <b>Digital Creative</b> </li>
			  <li><i class="fa fa-check" aria-hidden="true"></i> <b>Print & newspaper ads</b> </li>
			   <li><i class="fa fa-check" aria-hidden="true"></i> <b>Television ads – TVC films</b> </li>
			   <li><i class="fa fa-check" aria-hidden="true"></i> <b>Corporate film & Explainer Videos</b> </li>
			   <li><i class="fa fa-check" aria-hidden="true"></i> <b>Product Packaging</b> </li>
			   <li><i class="fa fa-check" aria-hidden="true"></i> <b>Social Media Graphics</b> </li>
			   <li><i class="fa fa-check" aria-hidden="true"></i> <b>Broucher & Presentation Designs</b> </li>
			    <li><i class="fa fa-check" aria-hidden="true"></i> <b>Animations & Gifs</b> </li>
			     <li><i class="fa fa-check" aria-hidden="true"></i> <b>Social Media Posts</b> </li>
            </ul>
